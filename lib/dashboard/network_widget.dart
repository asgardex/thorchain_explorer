      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            StatListItem(label: "Bonding APY", value: network.bondingAPY.round().toString()),
            StatListItem(label: "Active Node Count", value: f.format(network.activeNodeCount)),
            StatListItem(label: "Liquidity APY", value: "${network.liquidityAPY}%"),
            StatListItem(label: "Next Churn Height", value: network.nextChurnHeight.toString()),
            StatListItem(label: "Pool Activation Countdown", value: network.poolActivationCountdown.toString()),
            StatListItem(label: "Pool Share Factor", value: "${network.poolShareFactor}"),
