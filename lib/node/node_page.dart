                    ...
                    child: Table(
                        ...
                        children: [
                          ...
                          TableRow(children: [
                            ...
                            PaddedTableCell(
                                child: SelectableText(node.status.toString())),
                          ]),
                          TableRow(children: [
                          ...
                          TableRow(children: [
                            ...
                            PaddedTableCell(
                                child: SelectableText(
                                    f.format(node.currentAward / pow(10, 8)))),
                          ]),
                          TableRow(children: [
                            PaddedTableCell(
                                child: SelectableText("Public Keys secp256k1")),
                            PaddedTableCell(
                                child:
                                    SelectableText(node.publicKeys.secp256k1)),
                          ]),
                          TableRow(children: [
                            PaddedTableCell(
                                child: SelectableText("Public Keys ed25519")),
                            PaddedTableCell(
                                child: SelectableText(node.publicKeys.ed25519)),
                          ]),
                          TableRow(children: [
                            PaddedTableCell(
                          ...
                          TableRow(children: [
                            ...
                            PaddedTableCell(
                                child: SelectableText(node.jail.nodeAddr != null
                                    ? node.jail.nodeAddr
                                    : "")),
                          ]),
                          TableRow(children: [
